...
class Rep_adj_trial_balance_c extends CI_Controller {
	...
	public function index(){
		...
		$data = array(
			'page' => 'report/rep_adj_trial_balance_v', 
			'dt' => $dt,
			'sel_date' => $sel_date,
			'tgl_awal' => $tgl_awal,
			'tgl_akhir' => $tgl_akhir,
			'post_url' => 'report/rep_adj_trial_balance_c',
		);
	...
	function cetak_excel(){
		...
		$view = "xls/rep_adj_trial_balance_xls";
	...
	function cetak_pdf(){
		$tgl_awal = $this->input->post('tgl_awal_2');
		$tgl_akhir = $this->input->post('tgl_akhir_2');
		$view = "pdf/rep_adj_trial_balance_pdf";
