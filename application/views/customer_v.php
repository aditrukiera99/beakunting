    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-header bg-success">CUSTOMER
                <a href="<?=base_url();?>add_customer_c"><button type="button" class="btn btn-labeled btn-danger" style="float: right;">
    ...
    <div class="col-lg-9">
        <div class="card">
            ...
            <div class="card-block cards_section_margin">
                ...
                <br>
                <div class="card">
                    <div class="card-header bg-primary disabled">TRANSAKSI CUSTOMER</div>
                    <div class="card-block cards_section_margin">
                        <div class="col-lg-12">
