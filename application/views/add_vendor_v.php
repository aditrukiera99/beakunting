                ...
                <div class="main-bar">
                    ...
                    <div class="col-sm-8">
                        <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                            ...
                            <li class="active breadcrumb-item">Tambah Vendors</li>
                        </ol>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="card-block cards_section_margin">
                        <div class="row">
                            ...
                            <ul class="nav nav-inline view_user_nav_padding">
                                ...
                                <li class="nav-item card_nav_hover">
                                    <a class="nav-link" href="#tab4"  id="followers" data-toggle="tab">Account Setting</a>
                                </li>
                                <li class="nav-item card_nav_hover">
                                    <a class="nav-link" href="#tab5"  id="followers" data-toggle="tab">Additional Info</a>
                                </li>
                            </ul>
                            <div id="clothing-nav-content" class="tab-content m-t-10">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab2">
                                    <div class="card_nav_body_padding">
                                        <div class="row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-2 col-xl-4">
                                                    <label for="name4" class=" col-form-label">Print Name On Check As</label>
                                                </div>
                                                <div class="col-lg-4 col-xl-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-2 col-xl-4">
                                                    <label for="name4" class=" col-form-label">Billing Rate Level</label>
                                                </div>
                                                <div class="col-lg-4 col-xl-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                    ...
                                    <div class="card_nav_body_padding follower_images">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
                                                    <div class="col-lg-2 col-xl-1">
                                                        <label for="name4" class=" col-form-label">Vendor Tax ID</label>
                                                    </div>
                                                    <div class="col-lg-4 col-xl-4">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab4">
                                    <div class="card_nav_body_padding follower_images">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label class="col-form-label" style="font-weight: bold;font-size: 20px;">Tell Us Which expense accounts to prefill when you enter bills for this vendor.</label>
                                                <br>
                                                <label class="col-form-label" style="font-size: 17px;">Spending a little time here can save you time later on.</label><br>
                                                <label class="col-form-label" style="font-size: 15px;">Accounts you select here show up automatically in the accounts field when you enter a bill for this vendor.</label><br>
                                                <label class="col-form-label" style="font-size: 15px;">Example : Bills from the phone company would be assigned the Telephone utilities expense account.</label><br>
                                                <div class="form-group row">
