    ...
    <div class="main-bar">
        ...
        <div class="col-sm-8">
            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                ...
                <li class="breadcrumb-item">
                    <a href="<?=base_url();?>items_c">Customer Type</a>
                </li>
                <li class="active breadcrumb-item">Add New Customer Type</li>
            </ol>
        </div>
        </div>
    </div>
...
<div class="alert alert-success alert-dismissable">
    ...
    <strong>Saved!</strong> New customer type has been saved.
</div>
<?PHP } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-xl-6">
                                            <select class="form-control chzn-select" name="anak_dari">
                                                <option value="<?=$dt->Subtype;?>"><?=$dt->SUB;?></option>
                    ...
                    <div class="col-lg-8">
                        <div class="form-group row">
                            <div class="col-lg-6 col-xl-12 text-lg-right">
                                ...
                                <a href="<?=base_url();?>customer_type_c" class="btn btn-primary">
