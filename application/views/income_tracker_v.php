...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header bg-white">UNBILLED</div>
                        ...
                        <div class="row icon_margin_left">
                            <div class="col-lg-5 col-5 icon_padd_left">
                                <div class="float-left">
                                    <span class="fa-stack fa-sm" style="padding-left: 38px;">
                            ...
                            <div class="col-lg-7 col-7 icon_padd_right">
                                <div class="float-right cards_content">
                                    <span class="number_val" id="sales_count">48,569.31</span>
                                    <br>
                                    <span class="card_description">6 Estimates</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row icon_margin_left">
                            ...
                            <div class="col-lg-7 col-7 icon_padd_right">
                                <div class="float-right cards_content">
                                    <span class="number_val" id="sales_count">48,569.31</span>
                                    <br>
                                    <span class="card_description">3 Sales Orders</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-4">
    <div class="card">
        <div class="card-header bg-white">UNPAID</div>
        <div class="card-block cards_section_margin">
            <div class="row">
                <div class="col-sm-6 col-12">
...
<div class="col-lg-4">
        <div class="card">
            <div class="card-header bg-white">PAID</div>
            <div class="card-block cards_section_margin">
                <div class="row">
                    <div class="col-sm-12 col-12">
                        <div class="bg-success disabled top_cards">
                            <div class="row icon_margin_left">
                                <div class="col-lg-5 col-5 icon_padd_left">
                                    <div class="float-left">
                                        <span class="fa-stack fa-sm" style="padding-left: 38px;">
