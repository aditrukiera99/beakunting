...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-success"><a href="<?=base_url();?>customer_c" style="color: #FFF; padding-right: 10px;"><i class="fa fa-arrow-left"></i></a> Detail Estimate</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3 col-xl-3 text-lg-right">
                                        <label style="margin-top: 0px;" for="so" class="col-form-label">ESTIMATE #</label>
                                    </div>
                                    <div class="col-lg-8 col-xl-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                        ...
                        <div class="col-lg-6">                            
                            <div class="form-group row">
                                <div class="col-lg-3 col-xl-3 text-lg-right">
                                    <label for="username4" class="col-form-label">Address</label>
                                </div>
                ...
                <div class="col-lg-7">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-xl-4" style="margin-top: 5px;">
                            ...
                            <input type="hidden" name="prosen_pajak" id="prosen_pajak" value="">
...
<div class="cd-popup" role="alert">
    <div class="cd-popup-container">
        ...
        <form id="delete" method="post" action="<?=base_url();?>estimate_c">
