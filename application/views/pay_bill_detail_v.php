...
<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>" onsubmit="return cek_form();">
<div class="row">
    <div class="col-12 data_tables">
        <div class="card">
            <div class="card-header bg-success"> <a href="<?=base_url();?>vendors_c" style="color: #FFF; padding-right: 10px;"><i class="fa fa-arrow-left"></i></a> DETAIL PAY BILL </div>                    
            <div class="card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-xl-8">
                                <div class="input-group">
                                    <select name="name" id="shw_bill" onchange="showDiv(this.value);" class="form-control" >
                                        <option value="2">Show All Bills</option>
                                        <option value="1">Due Or On Before</option>
                                    </select>
                                    &nbsp&nbsp&nbsp&nbsp
                                    <input disabled type="text" class="form-control" id="dp1" name="tgl"  >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-xl-8">
                                <div class="input-group">
                                    <select  class="form-control chzn-select" name="vend_id" id="vend_id" onchange="get_bill_list();">
                                        ...
                                        <?php foreach ($get_vend as $key => $value) { ?>
                ...
                <table id="div1" class="table table-stripped table-bordered">
                    ...
                    <tbody id="tes">
                        ...
                        <tr id="tr_<?=$row->ID_PEMBELIAN;?>" class="tr_utama" style="cursor:pointer;" onclick="select_bill(this, <?=$row->ID_PEMBELIAN;?>);">
                            <td align="left" style="vertical-align:middle;">
                                <input style="box-shadow: none;" type="checkbox" class="form-control" name="id_bill[]" value="<?=$row->ID_PEMBELIAN;?>" checked>
                                <input  type="hidden" class="form-control" name="id_bill2[]" value="<?=$row->ID_PEMBELIAN;?>" id="id_bill2_<?=$row->ID_PEMBELIAN;?>">
                            </td>
                            <td align="center" style="vertical-align:middle;">
                                <?=$row->TGL;?>
                                <input type="hidden" name="tgl_jatuh_tempo[]" value="<?=$row->TGL;?>" />
                            </td>
                            <td align="left" style="vertical-align:middle;">
                                <?=$row->SUPPLIER;?>
                            ...
                            <td align="center" style="vertical-align:middle;">
                                <?=$row->NO_BUKTI;?>
                                <input type="hidden" name="no_bukti[]" value="<?=$row->NO_BUKTI;?>" />
                            </td>
                            <td align="right" style="vertical-align:middle;">
                                <?=number_format($row->DUE_AMT);?>
                                <input type="hidden" name="amt_due[]" id="amt_due_<?=$row->ID_PEMBELIAN;?>" value="<?=$row->DUE_AMT;?>" />
                                <input type="hidden" name="amt_orig[]" id="amt_orig_<?=$row->ID_PEMBELIAN;?>" value="<?=$row->ORIGINAL_AMT;?>" />
                            </td>
                            <td align="right" style="vertical-align:middle;">
                                0
                                <input type="hidden" name="disc[]" id="disc_<?=$row->ID_PEMBELIAN;?>" value="0"/>
                            </td>
                            <td align="right" style="vertical-align:middle;">
                               0
                               <input type="hidden" name="credit[]" id="credit_<?=$row->ID_PEMBELIAN;?>" value="0" />
                            </td>
                            <td align="center" style="vertical-align:middle;">
                                <div class="span12">
                                    <div class="control-group">
                                        <div class="controls">
                                            <input id="amt_pay_<?=$row->ID_PEMBELIAN;?>" value="<?=number_format($row->PAYMENT);?>" onkeyup="FormatCurrency(this); cek_amt('+res.ID+'); hitung_all();" type="text" class="form-control" name="amt_pay[]" style="text-align:right;">
                                        </div>
                                    </div>
                                </div>
                            </td>
            ...
            <div class="card-block">
              <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-2 col-xl-2">
                        <input type="text" class="form-control" id="bill_due" name="tgl_pay" value="<?=$dt->TGL;?>">
                    </div>
                    <div class="col-lg-1 col-xl-1">
                    ...
                    <div class="col-lg-2 col-xl-2">
                        <select name="metode_bayar" id="cboOptions" class="form-control" >
                            <option <?PHP if($dt->METODE_BAYAR == "Cash" ){ echo "selected"; } ?> value="Cash">Cash</option>
                            <option <?PHP if($dt->METODE_BAYAR == "Check" ){ echo "selected"; } ?> value="Check">Check</option>
                            <option <?PHP if($dt->METODE_BAYAR == "Credit" ){ echo "selected"; } ?> value="Credit">Credit</option>
                            <option <?PHP if($dt->METODE_BAYAR == "Online Bank Pmt" ){ echo "selected"; } ?> value="Online Bank Pmt">Online Bank Pmt</option>
                        </select>
                    </div>
                    <div class="col-lg-1 col-xl-1">
                    ...
                    <div class="col-lg-2 col-xl-2">
                        <select class="form-control" name="kode_akun">
                            ...
                            <option <?PHP if($dt->KODE_AKUN == $row->KODE_AKUN ){ echo "selected"; } ?> value="<?=$row->KODE_AKUN;?>"><?=$row->KODE_AKUN;?> - <?=$row->NAMA_AKUN;?></option>
                            <?PHP } ?>                            
                        </select>
                    </div>                    
                </div>
...
<div class="cd-popup" role="alert">
    <div class="cd-popup-container">
        ...
        <form id="delete" method="post" action="<?=base_url();?>pay_bill_c">
