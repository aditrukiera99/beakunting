...
<table align="center" class="grid">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="5" style="border-top: 2px solid #000 !important; text-align: center; vertical-align: middle;"><b>TOTAL</b></td>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle('AdjJournal');
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('AdjJournal.pdf');
?>