...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-white">Rock Castle Construction</div>
            <div class="card-block cards_section_margin">
                <br>
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header bg-mint disabled">Home</div>
                            <div class="card-block">
                                ...
                                <div class="form-group row" style="margin-bottom: 0rem !important;">
                                    ...
                                    <div class="col-lg-1  text-lg-right" style="height:50px;background: url(<?=base_url();?>/assets/img/garisatas.png) no-repeat center;">
                                    </div>
                                    <div class="col-lg-5">
                                    </div>
                                ...
                                <div class="form-group row" style="margin-bottom: 0rem !important;">
                                    ...
                                    <div class="col-lg-1" >
                                        <img src="<?=base_url();?>/assets/img/enter time.png">
                                    </div>
                                    <div class="col-lg-1" style="height:50px;background: url(<?=base_url();?>/assets/img/garis.png) no-repeat center;">
                                    </div>
                                    <div class="col-lg-1" >
                    ...
                    <div class="col-lg-3">                        
                        <div class="card">
                            <div class="card-header bg-mint disabled">Company </div>
                            <div class="card-block">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 text-lg-center" style="height:50px;background: url(<?=base_url();?>/assets/img/garis.png) no-repeat center;">
                                    </div>
                                    
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6 text-lg-center" >
                                        <img src="<?=base_url();?>/assets/img/record deposit.png">
                                    </div>
                                    <div class="col-lg-6 text-lg-center" >
                                        <img src="<?=base_url();?>/assets/img/reconcile.png">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6 text-lg-center" >
                                        <img src="<?=base_url();?>/assets/img/write checks.png">
                                    </div>
                                    <div class="col-lg-6 text-lg-center" >
                                        <img src="<?=base_url();?>/assets/img/check register.png">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6 text-lg-center" >
