        ...
        <div class="card">
            ...
            <div class="card-block cards_section_margin">                
                ...
                <table class="table table-bordered table-hover table-striped">
                    <thead>
                    <tr>
                        <th class="bg-success" "><input type="checkbox" class="form-control" name=""></th>
                        <th class="bg-success" ">NAME</th>
                        <th class="bg-success" ">BALANCE</th>
                        <th class="bg-success" ">TERMS</th>
                    </tr>
                </thead>
                <tbody>
                    <?PHP foreach ($dt as $key => $rowa) { ?>
                    <tr id="data_<?=$rowa->ID;?>" onclick="get_information('<?=$rowa->ID;?>');" style="cursor: pointer;" class="tbl_customer">
                        <td><input type="checkbox" class="form-control" name=""></td>
                        <td><?php if($rowa->NAMA_USAHA == "" || $rowa->NAMA_USAHA == null){ echo $rowa->NAMA_PELANGGAN; } else { echo $rowa->NAMA_USAHA; } ?></td>
                        <td><?=number_format($rowa->BALANCE - $rowa->PAID - $rowa->PAID2);?></td>
                        <td><?=$rowa->TERMS;?></td>
                    </tr>
                    <?PHP } ?>
                </tbody>
