...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-success"> <a href="<?=base_url();?>vendors_c" style="color: #FFF; padding-right: 10px;"><i class="fa fa-arrow-left"></i></a> DETAIL BILL </div>
                    ...
                    <div class="row baris" id="bank">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-xl-6">
                                    <div class="input-group">
                                        <textarea class="form-control" type="text" rows="3" name="ven_address" id="ven_address"><?=$dt->ALAMAT;?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-xl-6">
                                    <div class="input-group">
                                        <textarea class="form-control" type="text" rows="3" name="memo"><?=$dt->SUPPLIER;?><?=$dt->MEMO;?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-xl-6">
                                    <div class="input-group">
                                        <select class="form-control" name="terms" onchange="get_due_date(this.value);" required>
                                            <option <?PHP if($row->TERMS == "Due on Receipt"){ echo "selected"; } ?> value="Due on Receipt">Due on Receipt</option>
                                            <option <?PHP if($row->TERMS == "NET 15"){ echo "selected"; } ?> value="NET 15">NET 15</option>
                                            <option <?PHP if($row->TERMS == "NET 30"){ echo "selected"; } ?> value="NET 30">NET 30</option>
                                            <option <?PHP if($row->TERMS == "NET 60"){ echo "selected"; } ?> value="NET 60">NET 60</option>
                                        </select>
                                    </div>
                                </div>
                            </div>                                
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-xl-4">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input readonly style="background: #FFF;" type="text" name="tgl" class="form-control" placeholder="dd-mm-yyyy" id="dp1" value="<?=$dt->TGL_TRX;?>">
                                    </div>
                                </div>                                    
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-xl-4">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input readonly style="background: #FFF;" type="text" name="bill_due" class="form-control" placeholder="dd-mm-yyyy" id="bill_due" value="<?=$dt->TGL_JATUH_TEMPO;?>">
                                    </div>
                                </div>                                    
                            </div>
                        </div>
...
<div class="cd-popup" role="alert">
    <div class="cd-popup-container">
        ...
        <form id="delete" method="post" action="<?=base_url();?>bill_c">
