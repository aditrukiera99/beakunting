...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-success"><a href="<?=base_url();?>customer_c" style="color: #FFF; padding-right: 10px;"><i class="fa fa-arrow-left"></i></a> DETAIL INVOICE</div>
...
<div class="cd-popup" role="alert">
    <div class="cd-popup-container">
        ...
        <form id="delete" method="post" action="<?=base_url();?>invoice_c">
