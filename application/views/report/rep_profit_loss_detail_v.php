...
<table class="table table-bordered table_report">
	...
	<tbody>
		...
		<tr>
			...
			<td style="text-align: right; font-size: 20px;" colspan="8"></td>
		</tr>
		<?PHP 
		$id_voc = "";
		$total_deb_all = 0;
		...
		foreach ($dt2 as $key => $row) { 
			$total_deb_all_2 += $row->DEBET;
			$total_kre_all_2 += $row->KREDIT;
		?>
		...
		<tr>
			<td style="border-top: 3px solid #000 !important; text-align: left; vertical-align: middle;" colspan="7"><b>TOTAL EXPENSES</b></td>
			<td style="border-top: 3px solid #000 !important; text-align: right; font-size: 20px;"><b><?=number_format($total_deb_all_2);?></b></td>
			<td style="border-top: 3px solid #000 !important; text-align: right; font-size: 20px;"><b><?=number_format($total_kre_all_2);?></b></td>
		</tr>

		<tr>
			<td style="border-top: 3px solid #000 !important; text-align: left; vertical-align: middle;" colspan="7"><b>NET INCOME</b></td>
			<td style="border-top: 3px solid #000 !important; text-align: right; font-size: 20px;"><b><?=number_format($total_deb_all - $total_deb_all_2);?></b></td>
			<td style="border-top: 3px solid #000 !important; text-align: right; font-size: 20px;"><b><?=number_format($total_kre_all - $total_kre_all_2);?></b></td>
		</tr>
