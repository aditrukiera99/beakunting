...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-success"> <a href="<?=base_url();?>vendors_c" style="color: #FFF; padding-right: 10px;"><i class="fa fa-arrow-left"></i></a> DETAIL CREDIT </div>
...
<div class="cd-popup" role="alert">
    <div class="cd-popup-container">
        ...
        <form id="delete" method="post" action="<?=base_url();?>credit_vendor_c">
